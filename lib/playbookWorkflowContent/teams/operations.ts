...
export const operationsPlaybookWorkflow = playbookContent(
  ...
  [
    workflow(
      ...
      'Vendor request',
      [
        { label: 'New vendor form', kind: 'trigger', iconDomain: 'gator' },
        ...
        { label: 'Procurement gate', kind: 'gate', iconDomain: 'gator' },
      ],
    ...
    workflow(
      ...
      [
        ...
        { label: 'Ops lead gate', kind: 'gate', iconDomain: 'gator' },
      ],
    ...
    workflow(
      ...
      [
        ...
        { label: 'Owner gate', kind: 'gate', iconDomain: 'gator' },
      ],
