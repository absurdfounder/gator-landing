  ...
  playbooks: [
    {
      ...
      nodes: [
        ...
        { id: 'g1', label: 'Merge gate', x: 82, y: 52, kind: 'gate', iconDomain: 'gator' },
      ],
      edges: [
        { from: 't1', to: 'a1' },
        { from: 'a1', to: 'a2' },
    ...
    },
    {
      ...
      nodes: [
        ...
        { id: 'g1', label: 'Deploy verify', x: 84, y: 48, kind: 'gate', iconDomain: 'gator' },
      ],
      edges: [
        { from: 't1', to: 'a1' },
        { from: 'a1', to: 'a2' },
    ...
    },
    {
      ...
      nodes: [
        { id: 't1', label: 'Weekly cut', x: 12, y: 34, kind: 'trigger', iconDomain: 'gator' },
        ...
        { id: 'g1', label: 'Ship approval', x: 82, y: 50, kind: 'gate', iconDomain: 'gator' },
      ],
      edges: [
        { from: 't1', to: 'a1' },
        { from: 'a1', to: 'a2' },
