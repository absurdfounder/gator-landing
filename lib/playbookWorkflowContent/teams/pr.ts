...
export const prPlaybookWorkflow = playbookContent(
  ...
  [
    workflow(
      ...
      'News hook detected',
      [
        { label: 'News alert', kind: 'trigger', iconDomain: 'gator' },
        ...
        { label: 'Comms gate', kind: 'gate', iconDomain: 'gator' },
      ],
    ...
    workflow(
      ...
      [
        ...
        { label: 'Spokesperson gate', kind: 'gate', iconDomain: 'gator' },
      ],
    ...
    workflow(
      ...
      'Launch approved',
      [
        { label: 'Launch go', kind: 'trigger', iconDomain: 'gator' },
