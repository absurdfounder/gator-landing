...
export const metadata = buildPageMetadata({
  title: 'Hire a Gator Expert',
  description:
    'Hire Gator Agency when your ready to grow beyond we can help setup, design and manage your helpdesk, blog, or even marketplace. Also add custom code to your website deployment to make sure your needs are always met.',
  canonical: 'https://gator.so/agency',
  ogKind: 'page',
  ogSlug: 'agency',
});
                ...
                <div className="pb-6 md:pb-6">
                    ...
                    <div className="max-w-4xl py-6 mx-auto lg:py-6">
                        ...
                        <div className="text-center">
                            <h1 className="md:text-5xl font-bold tracking-tight text-slate-900 sm:text-4xl font-funneldisplay font-extrabold leading-tighter tracking-tighter mb-4 aos-init aos-animate"><span className="gradient-text-accent">Hire a Gator  Expert</span> to help you grow beyond the limitations.</h1>
                            <p className="mt-6 leading-7 text-slate-600 sm:text-lg sm:leading-8">
                                If your ready to grow from a 100 users to 10,000 , We can customize your Gator  site to match your needs.
                            </p>
                        ...
                        <div className="px-6 pt-5 pb-10 bg-white lg:px-8">
                            <div className="max-w-4xl mx-auto text-center">
                                ...
                                <h2 className="mt-2 text-2xl font-bold tracking-tight text-slate-900 sm:text-4xl">
                                    What can Gator  Experts do for you?
                                </h2>
