      ...
      {/* Integration details here */}
            ...
            <div className="space-y-8 bg-slate-100 p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-4" >
                    ...
                    <div className="space-y-2" >
                      ...
                      <p className="text-md text-slate-600">By Gator</p>
                    </div>
                  </div>
                  ...
                  <div className="flex space-x-2 items-center" >
                    <Link href="https://app.gator.so/integrations/arcade" className="bg-slate-900 hover:bg-slate-700 text-white font-bold py-2 px-4 rounded-md inline-flex items-center"  target="_blank" rel="noopener" >
                      <span>Install</span>
                    </Link>
                  </div>
                </div>
              ...
              <div>
                ...
                <p>Arcade lets you create interactive product demos in minutes and turn all users into power users. Let users experience your product through interactive, guided demos. No more pausing and rewinding, users can progress at their own pace. This integration allow you to embed Arcade interactive demos into your Gator  documentation.</p>
                <h3 className="h3 font-bold mt-4 mb-4">How it works</h3>
                <p>Embedding an Arcade flow in your documentation is simple - just paste an Arcade flow link into the Gator  editor. The app will turn the link into an Arcade embed showing your recorded demo.</p>
