...
const WonderComparison: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-pink-50 py-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
              ...
              {features.map((feature, index) => {
                ...
                return (
                  <div key={index} className="flex items-center justify-between py-3 border-b border-gray-100 last:border-b-0">
                    ...
                    <span className="text-sm text-emerald-500 font-medium">{feature.otherPlatform}</span>
                  </div>
                );
              })}
            </div>
            ...
            <div className="mt-6 p-4 bg-emerald-50 rounded-lg border border-emerald-200">
              <div className="flex items-center">
                ...
                <span className="text-sm font-medium text-emerald-700">Hours spent on tedious integrations and configurations</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200 relative overflow-hidden">
            ...
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl font-bold text-emerald-500">WONDER</h2>
            </div>
            ...
            <div className="mt-6 p-4 bg-emerald-50 rounded-lg border border-emerald-200">
              <div className="flex items-center">
                ...
                <span className="text-sm font-medium text-emerald-700">Everything you need, ready to use instantly</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          <div className="inline-flex items-center px-6 py-3 bg-emerald-500 text-white rounded-full font-medium shadow-lg hover:bg-emerald-600 transition-colors cursor-pointer">
